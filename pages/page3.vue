  ...
  <div class="space-y-8 max-w-4xl">
    <div class="flex items-start">
      <div class="flex-shrink-0">
        <svg class="h-6 w-6 text-dodger-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"
      ...
      <div class="ml-4">
        ...
        <p class="text-sm text-[#333] mt-4">Go to eagle.northwestu.edu and access "my profile", 
            scroll down to the bottom of the page and click "reset password". You can also call 
            IT services and ask them to update your password to a temporary login.</p>
      </div>
    </div>
    <div class="flex items-start">
      <div class="flex-shrink-0">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">How can I login to the authenticator app?</h3>
